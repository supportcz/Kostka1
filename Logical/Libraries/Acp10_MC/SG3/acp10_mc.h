...
/* Constants */
 ...
 _IEC_CONST signed short mcNETWORK_CYCLE_TIME = 1017;
 ...
 _IEC_CONST unsigned char mcMASTER_INTERVAL = 0U;
...
void MC_100BR_CamIn(struct MC_100BR_CamIn* inst);
