...
TYPE
    MpAxisErrorEnum : 
        ...
        mpAXIS_ERR_CONFIG_LOAD := -1064239094, (* Error loading configuration [Error: 10, 0xc091000a] *)
        mpAXIS_WRN_CONFIG_LOAD := -2137980917, (* Warning loading configuration [Warning: 11, 0x8091000b] *)
        mpAXIS_ERR_CONFIG_SAVE := -1064239092, (* Error saving configuration [Error: 12, 0xc091000c] *)
        ...
        mpAXIS_WRN_CFG_WAIT_ERROR_RESET := -2137816574, (* Update configuration requested waits error reset [Warning: 33282, 0x80938202] *)
        ...
        mpAXIS_ERR_PLC_OPEN := -1064074747, (* PLCopen error active [Error: 33285, 0xc0938205] *)
        mpAXIS_WRN_PLC_OPEN := -2137816570, (* PLCopen warning active [Warning: 33286, 0x80938206] *)
        ...
        mpAXIS_ERR_NO_CAM_NAME := -1064074728, (* No name for cam profile [Error: 33304, 0xc0938218] *)
        mpAXIS_WRN_SLAVE_NOT_READY := -2137816551, (* Slave not ready [Warning: 33305, 0x80938219] *)
        mpAXIS_ERR_CHECK_SLAVE_STATUS := -1064074726, (* Error on slave during last command [Error: 33306, 0xc093821a] *)
        mpAXIS_ERR_CMD_WRONG_AXISTYPE := -1064074725, (* Invalid axis type for this command [Error: 33307, 0xc093821b] *)
        mpAXIS_WRN_PARAMETER_LIMITED := -2137816548, (* Parameter was limited [Warning: 33308, 0x8093821c] *)
        ...
        mpAXIS_ERR_RECOVERY_NOT_ALLOWED := -1064074721 (* Recovery command called when not allowed [Error: 33311, 0xc093821f] *)
        );
END_TYPE
