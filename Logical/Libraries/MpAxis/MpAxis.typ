(*----------------- MpAxisBasic: RUNTIME PARAMETERS STRUCTURE -----------------------------------------------------------*)
...
(*----------------- MpAxisBasic: ADDITIONAL INFORMATION STRUCTURE ------------------------------------------------------*)
...
(*----------------- MpAxisBasic: AXIS CONFIGURATION STRUCTURE ------------------------------------------------------------------------*)
...
(*----------------- MpAxisBasic: DRIVE CONFIGURATION STRUCTURE ---------------------------------------------------------------------*)
...
(*----------------- MpAxisBasicConfig: ADDITIONAL INFORMATION STRUCTURE --------------------------------------------------*)
...
(*----------------- MpAxisCoupling: PARAMETER STRUCTURE --------------------------------------------------------------------*)
...
(*----------------- MpAxisCyclicSet: PARAMETERS STRUCTURE ------------------------------------------------------------------------*)
...
(*----------------- MpAxisCamSequencer: PARAMETERS STRUCTURE ---------------------------------------------------------------------*)
